...
public class Module4_Tests {
    ...
    public void task_7() {
        ...
        boolean h3CorrectText = h3Elem.text().contains("Gregory Roberts");

        message = "Task 7: The first post's first `<h3>` tag should display `Gregory Roberts` as the author.";
